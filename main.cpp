...
int main(){
    ...
    if(kind == 1){
        ...
        string line = "ア カ サ タ ナ ハ マ ヤ ラ ワ イ キ シ チ ニ ヒ ミ リ ウ ク ス ツ ヌ フ ム ユ ル ン エ ケ セ テ ネ ヘ メ レ オ コ ソ ト ノ ホ モ ヨ ロ ヲ ガ ザ ダ バ パ ギ ジ ジ ビ ピ グ ズ ズ ブ プ ゲ ゼ デ ベ ペ ゴ ゾ ド ボ ポ キャ ギャ シャ ジャ チャ ニャ ヒャ ビャ ピャ ミャ リャ キュ ギュ シュ ジュ チュ ニュ ヒュ ビュ ピュ ミュ チュ キョ ギョ ショ ジョ チョ ニョ ヒョ ビョ ピョ ミョ リョ";
        i = 0;
        stringstream ssin(line);
        while (ssin.good() && i < N){
            ssin >> japanese[i];
